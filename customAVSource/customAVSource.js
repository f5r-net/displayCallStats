...
navigator.mediaDevices
  ...
  .then((mediaStream) => {
  agoraAudioTrack = mediaStream.getAudioTracks();
  });
...
width: 1280, height: 720, frameRate: 30, bitrateMax: 800, bitrateMin:400, mediaStreamTrack: videoStream.getVideoTracks()[0], optimizationMode: "detail"});

    localTracks.audioTrack = await AgoraRTC.createCustomAudioTrack({
      encoderConfig: "speech_standard", mediaStreamTrack: agoraAudioTrack
    })
  }
